...
- Keys, tokens, certificates, connection strings, internal hostnames, identity
  records, user content, or private repository source.
- Claims of official LEAP or DeepFest sponsorship, partnership, endorsement,
...
This release is a non-enabling product and evidence summary. It records public
outcomes and provenance while withholding implementation details that could
enable reverse engineering. It is not a legal opinion on novelty,
patentability, freedom to operate, trademark registration, or Nice
classification. Filing decisions remain with the owner and qualified counsel.

## Brand and event rule

“LEAP” and “DeepFest” identify the events and remain the property of their
